...
import { initMultiStep, goToStep, showStep, hideStep, getCurrentStepInfo } from './modules/multiStep.js';
...
export { FormState, initBranching, resetBranching, getNextStep, initMultiStep, goToStep, showStep, hideStep, getCurrentStepInfo, initValidation, validateField, validateStep, validateAllVisibleFields, initErrors, showError, clearError, clearAllErrors, initSummary, updateSummary, clearSummary };
