...
import { logVerbose, queryAllByAttr, getAttrValue, delegateEvent, showElement, hideElement, isVisible, addClass, removeClass } from './utils.js';
 ...
 */
export function hideStep(stepIndex) {
    if (stepIndex < 0 || stepIndex >= steps.length)
        return;
    const step = steps[stepIndex];
    hideElement(step.element);
